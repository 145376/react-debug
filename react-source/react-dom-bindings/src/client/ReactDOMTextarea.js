...
export function hydrateTextarea(element, value, defaultValue) {
  var node = element;
  ...
  var stringValue = toString(getToStringValue(initialValue));
  var changed = trackHydrated(node, stringValue, false);
