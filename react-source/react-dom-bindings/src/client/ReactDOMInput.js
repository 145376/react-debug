...
export function updateInput(element, value, defaultValue, lastDefaultValue, checked, defaultChecked, type, name) {
...
export function initInput(element, value, defaultValue, checked, defaultChecked, type, name, isHydrating) {
  var node = element;
...
export function hydrateInput(element, value, defaultValue, checked, defaultChecked) {
  var node = element;
  var defaultValueStr = defaultValue != null ? toString(getToStringValue(defaultValue)) : '';
  ...
  var initialChecked = typeof checkedOrDefault !== 'function' && typeof checkedOrDefault !== 'symbol' && !!checkedOrDefault; // Detach .checked from .defaultChecked but leave user input alone

  node.checked = node.checked;
  var changed = trackHydrated(node, initialValue, initialChecked);
