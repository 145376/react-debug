...
import { flushSyncFromReconciler as flushSyncWithoutWarningIfAlreadyRendering, isAlreadyRendering, injectIntoDevTools, findHostInstance } from 'react-reconciler/src/ReactFiberReconciler';
import { createPortal as createPortalImpl } from 'react-reconciler/src/ReactPortal';
import { canUseDOM } from 'shared/ExecutionEnvironment';
import ReactVersion from 'shared/ReactVersion';
import { ensureCorrectIsomorphicReactVersion } from '../shared/ensureCorrectIsomorphicReactVersion';
ensureCorrectIsomorphicReactVersion();
import { getInstanceFromNode, getNodeFromInstance, getFiberCurrentPropsFromNode } from 'react-dom-bindings/src/client/ReactDOMComponentTree';
import { enqueueStateRestore, restoreStateIfNeeded } from 'react-dom-bindings/src/events/ReactDOMControlledComponent';
import Internals from '../ReactDOMSharedInternalsFB';
export { prefetchDNS, preconnect, preload, preloadModule, preinit, preinitModule } from '../shared/ReactDOMFloat';
export { useFormStatus, useFormState, requestFormReset } from 'react-dom-bindings/src/shared/ReactDOMFormActions';
...
var flushSync = disableLegacyMode ? flushSyncIsomorphic : flushSyncFromReconciler;
...
export { createPortal, unstable_batchedUpdates, flushSync, ReactVersion as version, // enableCreateEventHandleAPI
