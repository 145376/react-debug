...
import { REACT_ELEMENT_TYPE, REACT_FRAGMENT_TYPE, REACT_LAZY_TYPE } from 'shared/ReactSymbols';
...
export function jsxProdSignatureRunningInDevWithDynamicChildren(type, config, maybeKey, source, self) {
  if (__DEV__) {
    ...
    var trackActualOwner = __DEV__ && ReactSharedInternals.recentlyCreatedOwnerStacks++ < ownerStackLimit;
    return jsxDEVImpl(type, config, maybeKey, isStaticChildren, source, self, __DEV__ && (trackActualOwner ? Error('react-stack-top-frame') : unknownOwnerDebugStack), __DEV__ && (trackActualOwner ? createTask(getTaskName(type)) : unknownOwnerDebugTask));
  }
}
...
export function createElement(type, config, children) {
  ...
  var trackActualOwner = __DEV__ && ReactSharedInternals.recentlyCreatedOwnerStacks++ < ownerStackLimit;
  return ReactElement(type, key, undefined, undefined, getOwner(), props, __DEV__ && (trackActualOwner ? Error('react-stack-top-frame') : unknownOwnerDebugStack), __DEV__ && (trackActualOwner ? createTask(getTaskName(type)) : unknownOwnerDebugTask));
}
export function cloneAndReplaceKey(oldElement, newKey) {
  var clonedElement = ReactElement(oldElement.type, newKey, undefined, undefined, !__DEV__ ? undefined : oldElement._owner, oldElement.props, __DEV__ && oldElement._debugStack, __DEV__ && oldElement._debugTask);
  if (__DEV__) {
...
export function cloneElement(element, config, children) {
  ...
  var owner = !__DEV__ ? undefined : element._owner;
  if (config != null) {
  ...
  var clonedElement = ReactElement(element.type, key, undefined, undefined, owner, props, __DEV__ && element._debugStack, __DEV__ && element._debugTask);
