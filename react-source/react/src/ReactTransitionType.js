...
import { enableViewTransition, enableGestureTransition } from 'shared/ReactFeatureFlags';
      ...
      if (__DEV__) {
        if (ReactSharedInternals.asyncTransitions === 0) {
          if (enableGestureTransition) {
            ...
            console.error('addTransitionType can only be called inside a `startTransition()` ' + 'callback. It must be associated with a specific Transition.');
          }
        }
      }
