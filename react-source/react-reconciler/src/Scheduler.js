...
export var IdlePriority = Scheduler.unstable_IdlePriority;
// this doesn't actually exist on the scheduler, but it *does*
// on scheduler/unstable_mock, which we'll need for internal testing
export var log = Scheduler.log;
export var unstable_setDisableYieldValue = Scheduler.unstable_setDisableYieldValue;